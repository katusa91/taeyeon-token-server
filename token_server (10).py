        ...
        config={
            ...
            "live_connect_constraints": {
                ...
                "config": {
                    ...
                    # 자동 VAD(음성 감지)가 사용자가 말을 꺼내기도 전에 짧은 잡음/숨소리를
                    # "한 턴 끝"으로 오판해 엉뚱한 언어의 단어를 전사해버리는 Live API의
                    # 알려진 오작동을 피하기 위해, 자동 감지를 끄고 클라이언트(오브 클릭)가
                    # 직접 activityStart/activityEnd 신호를 보내도록 한다.
