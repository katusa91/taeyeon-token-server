...
# 현재 사용 모델: gemini-2.5-flash-native-audio-preview-12-2025. 문제가 생기면 Railway 환경변수
# LIVE_MODEL로 다른 모델(예: models/gemini-3.8-live)로 즉시 되돌릴 수 있다.
MODEL_NAME = os.environ.get("LIVE_MODEL", "models/gemini-2.5-flash-native-audio-preview-12-2025")
